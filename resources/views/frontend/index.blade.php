								...
								<div class="row">
									...
									<div class="col-xl-7 col-md-6 d-flex align-items-center justify-content-center mb-4 mb-4d-0">
										<div class="banner__block__image d-inline-block position-relative layer" data-depth="0.2">
											<img src="{{ asset('uploads/home_banner') }}/{{ $banner->thumbnail }}" alt="banner-village" class="h-100 {{ $banner->id != 5 ? "w-100" : "" }}">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-12">
					<ul class="nav nav-pills justify-content-center mb-5" id="pills-tab" role="tablist">
						...
						<li class="nav-item mb-2" role="presentation">
							<a class="nav-link transition {{ ($loop->index+1 == 1 ) ? ' active': 'no' }}" id="first-floor-tab-{{ $layout->id }}" data-toggle="pill" href="#first-floor-{{ $layout->id }}" role="tab" aria-controls="first-floor" aria-selected="true">{{ $layout->floor_name }}</a>
						</li>
                        @endforeach
						{{-- <li class="nav-item mb-2" role="presentation">
					...
					<div class="tab-content" id="pills-tabContent">
                        @foreach ($layouts as $layout)
						<div class="tab-pane fade {{ ($loop->index+1 == 1 ) ? 'show active': ' ' }}" id="first-floor-{{ $layout->id }}" role="tabpanel" aria-labelledby="first-floor-tab-{{ $layout->id }}">
							<div class="layouts__block row">
								<div class="col-md-6 d-flex align-items-center justify-content-center mb-5 mb-md-0">
									<img src="{{ asset('uploads/layout_photo') }}/{{ $layout->photo }}" alt="layouts-1" class="layouts__block__image img-fluid">
								</div>
								<div class="col-md-6 pl-xl-5">
									<h3 class="layouts__block__title text-capitalize">{{ $layout->floor_name }}</h3>
									<p class="layouts__block__text">{{ $layout->description }}</p>
									<div class="table-responsive pt-3">
										<table class="layouts__block__table table table-striped table-borderless">
											<tbody>
											  <tr>
												<td class="table__title">Floor</td>
												<th scope="row" class="table__value text-right">{{ $layout->floor_name }}</th>
											  </tr>
											  <tr>
												<td class="table__title">Total Area</td>
												<th scope="row" class="table__value text-right">{{ $layout->total_area }} Square Feets</th>
											  </tr>
											  <tr>
												<td class="table__title">Room</td>
												<th scope="row" class="table__value text-right">{{ $layout->room }}</th>
											  </tr>
											  <tr>
												<td class="table__title">Bed</td>
												<th scope="row" class="table__value text-right">{{ $layout->bed }}</th>
											  </tr>
											  <tr>
												<td class="table__title">Bath</td>
												<th scope="row" class="table__value text-right">{{ $layout->bath }}</th>
											  </tr>
											</tbody>
										</table>
									</div>
