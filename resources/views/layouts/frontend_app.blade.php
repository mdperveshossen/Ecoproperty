		...
		<nav class="navbar navbar-expand-lg px-md-5">
			<div class="container-fluid">
				<a class="navbar-brand" href="{{ route('index') }}">
					<img src="{{ asset('uploads/logo') }}/{{ $logo->logo }}" alt="logo" class="img-fluid header-logo">
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav text-capitalize text-center ml-auto">
						<li class="nav-item position-relative">
							<a class="nav-link transition @yield('home')" href="{{ route('index') }}">{{ $nav1->nav_item }}</a>
						</li>
						<li class="nav-item">
							<a class="nav-link position-relative transition @yield('about')" href="{{ route('about') }}">{{ $nav2->nav_item }}</a>
						</li>
						<li class="nav-item">
							<a class="nav-link position-relative transition" href="{{ route('index') }}#layouts">{{ $nav3->nav_item }}</a>
						</li>
						<li class="nav-item">
							<a class="nav-link position-relative transition @yield('gallery')" href="{{ route('gallery') }}">{{ $nav4->nav_item }}</a>
						</li>
						<li class="nav-item">
							<a class="nav-link position-relative transition @yield('location')" href="{{ route('location') }}">{{ $nav5->nav_item }}</a>
						</li>
						<li class="nav-item">
							<a class="nav-link position-relative transition" href="#schedule">{{ $nav6->nav_item }}</a>
						</li>
						<li class="nav-item">
							<a class="nav-link position-relative transition" href="#footer">{{ $nav7->nav_item }}</a>
						</li>
					</ul>
				</div>
			</div>
					...
					<div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
						<div class="footer__block">
							<a href="index.html" class="d-inline-block footer__logo">
								<img src="{{ asset('uploads/logo') }}/{{ $logo->logo }}"  alt="logo" class="img-fluid footer-logo" >
							</a>
							<div class="row mt-4">
