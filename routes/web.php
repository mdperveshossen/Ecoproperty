...
Route::get('home/navbar', 'HomeController@navbar')->name('navbar');
Route::get('home/navbar/update/{id}', 'HomeController@navbarupdate')->name('navbarupdate');
Route::post('home/navbar/update/post/{id}', 'HomeController@navbarupdatepost')->name('navbarupdatepost');
...
Route::post('home/layout/store', 'LayoutController@store')->name('layout.store');
Route::get('home/layout/show', 'LayoutController@show')->name('layout.show');
Route::get('home/layout/delete/{id}', 'LayoutController@delete')->name('layout.delete');
Route::get('home/layout/update/{id}', 'LayoutController@layoutupdate')->name('layout.update');
Route::post('home/layout/update/post/{id}', 'LayoutController@layoutupdatepost')->name('layout.update.post');
